...
const LettersGlitchGSAP = dynamic<LettersGlitchProps>(
  () => import("@/components/core/onHover/letter-glitch/framer/LettersGlitch")
);
...
function DynamicCard({ componentData }: { componentData: ComponentData }) {
  ...
  return (
    <div className="min-w-[200px] h-[250px] border border-neutral-800 flex justify-center items-center">
